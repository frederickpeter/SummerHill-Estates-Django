    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image1', models.ImageField(blank=True, max_length=255, null=True, upload_to='images/')),
                ('image2', models.ImageField(blank=True, max_length=255, null=True, upload_to='images/')),
                ('image3', models.ImageField(blank=True, max_length=255, null=True, upload_to='images/')),
                ('image4', models.ImageField(blank=True, max_length=255, null=True, upload_to='images/')),
                ('image5', models.ImageField(blank=True, max_length=255, null=True, upload_to='images/')),
                ('brochure', models.FileField(blank=True, max_length=255, null=True, upload_to='documents/')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration_type', models.CharField(choices=[('Day', 'Day'), ('Week', 'Week'), ('Month', 'Month'), ('Year', 'Year')], max_length=7)),
